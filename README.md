...
> **[🔗 Try it live on GitHub Pages →](https://<your-username>.github.io/<repo-name>/)**
...
├── docs/               # Screenshots
└── engine/             # C++17 multi-threaded DPI engine
...
2. **Test generator** — run `python engine/generate_test_pcap.py` from the project root
...
The `engine/` directory contains the full **[C++ DPI Engine](engine/README.md)** — a multi-threaded Deep Packet Inspection system with load balancers, fast-path processors, and SNI-based traffic classification. See [engine/README.md](engine/README.md) for build instructions and detailed documentation.
